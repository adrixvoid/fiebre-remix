...
import {
  ...
  type ContentType
} from '../services/front-matter';
import {parse} from '../services/marked';
...
export const createMarkdownTemplate = ({
  title,
  categories,
  preview,
  body,
...
export const createContent = async (post: MarkdownPost): Promise<boolean> => {
  try {
    console.log(post);
    ...
    // create file
    const markdown = createMarkdownTemplate(post);
