...
import { CategoryActionData } from "../categories.controller";
import { CATEGORY_PARAMS } from "~/constants";
...
export default function AdminCategoryForm() {
    ...
    const actionData = useActionData<CategoryActionData>() as CategoryActionData;
    ...
    return (
        <div className="container">
            ...
            <Form method="post" encType="multipart/form-data">
                ...
                <fieldset>
                    <InputFilePreview id="cover" name="cover" labelText="Select Cover" />
                </fieldset>
                ...
                <fieldset>
                    ...
                    <Button color="primary" type="submit" disabled={isSubmitting}>{isSubmitting ? "Please Wait..." : "Saving..."}</Button>
                </fieldset>
            </Form>
        </div>
    );
